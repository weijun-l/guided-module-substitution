"""
Main entry point for GMS (Guided Module Search) encoder purification
"""
...
def main():
    """Main function for GMS encoder purification."""
    parser = argparse.ArgumentParser(
        description="GMS (Guided Module Search) for Encoder Model Purification"
    )
    ...
    parser.add_argument("--alpha", type=float, default=DEFAULT_ALPHA,
                        help="Balance parameter: α for accuracy preservation, (1-α) for ASR reduction (default: 0.4)")
    ...
    # Print configuration
    print("=" * 100)
    print("GMS (GUIDED MODULE SEARCH) ENCODER PURIFICATION")
    print("=" * 100)
